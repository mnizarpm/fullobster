...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    ?>
    <a href="?Open=histori-user&id=<?php echo $id?>" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-md"><i class="fas fa-table fa-sm"></i>  Lihat history data</a>
</div>
